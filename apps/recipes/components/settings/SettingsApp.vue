...
const teleskopUpdateOptions = [t('OnAppStart'), t('Manual')]
const teleskopUpdateSelection = ref(teleskopUpdateOptions[1])
</script>
  ...
  <div class="flex flex-row align-start justify-center">
    ...
    <div class="flex-center flex-col gap-5 text-size-4 mt-10 w-full ">
      ...
      <div v-show="false" class="row-item">
        {{ t('TeleskopDataUpdates') }}
        <QSelect
          v-model="teleskopUpdateSelection"
          :options="teleskopUpdateOptions"
          class="w-100"
          filled
          dense
        />

...
import { matDisplaySettings, matPreview, matSettings } from '@quasar/extras/material-icons'
...
const settingItems = reactive([
  ...
  { name: 'advanced', caption: () => t('settings.advanced'), component: Advanced, icon: matSettings },
])
</script>

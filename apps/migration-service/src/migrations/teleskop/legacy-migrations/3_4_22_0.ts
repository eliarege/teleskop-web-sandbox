...
export async function legacyMigration_3_4_22_0(knex: Knex) {
  await knex.raw(`
    ALTER PROCEDURE [dbo].[spGetTheoricCommandNumbers] @BatchKey INT ,@IsArchiveData BIT,@Result INT OUTPUT
    AS

import type { CommandType, CommandTypeEvent, ErpParameter, FinishReason, Machine, ManualReason, RecipeType, StepReason, StopReason, TreatmentMachineGroup, User, WaterType } from '~/types'
...
export async function deleteUser(userIds: string[]) {
  await $fetch('/api/user-definitions/user-definition', { method: 'DELETE',
body: {
    userIds,
  } })
}

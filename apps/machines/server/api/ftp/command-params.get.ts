...
export default defineEventHandler(async () => {
  ...
  try {
    ...
    await knex('BFCOMMANDPARAMETERS').insert({
      ...
      PARAMETERTYPE: (c.selectionList || globalCommandFormula sonradan eklenecek) ? 1 : 0,

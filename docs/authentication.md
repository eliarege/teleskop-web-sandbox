...
Apps defined in this monorepo relies on [Keycloak](https://www.keycloak.org/) to handle user and identity management.
You can setup your Keycloak environment easily by following steps below.

## Setting up Keycloak

### Requirements

- [Docker Engine](https://docs.docker.com/engine/install/) (with `compose` plugin installed)
